...
<body>
  <nav><a href="../index.php">Home</a> | <a href="teachers_add.php">Add Teacher</a></nav>
          ...
          <?php foreach ($teachers as $t): ?>
            <tr>
              ...
              <td>
                ...
                <a href="teachers_delete.php?id=<?=urlencode($t['t_id'])?>" onclick="return confirm('Delete this teacher?')">Delete</a>
              </td>
            </tr>
          <?php endforeach; ?>
        <?php endif; ?>
